...
export class MyApp {
  ...
  constructor(
    ...
    this.pages = [
      ...
      { title: "Today is the Day", component: "TodayIsTheDayPage", separatorLevel: 4, icon: "calendar-check-o" },
      { title: "Getting It Right", component: "GettingItRightPage", separatorLevel: 4, icon: "thumbs-up" },
      { title: "Meet Our Cofounder", component: "MeetOurCofounderPage", separatorLevel: 4, icon:"female" },

      // GetFree - Money
      { title: "Money", component: null, separatorLevel: 2, icon: null },
      { title: "Eat It, Love It, Share It", component: "EatItLoveItShareItPage", separatorLevel: 4, icon: "cutlery" },
      { title: "Compensation Plan", component: "CompensationPlanPage", separatorLevel: 4, icon: "usd" },
      ...
      { title: "30-day Guide", component: "ThirtyDayGuidePage", separatorLevel: 4, icon: "book" },
      { title: "Core 4 / Packs (USA)", component: "Core_4PacksUsaPage", separatorLevel: 4, icon: "archive" },
      ...
      { title: "Health to Wealth", component: "HealthToWealthPage", separatorLevel: 4, icon: "medkit" },

      // GetFree - Global Exec Team
      { title: "Global Exec Team", component: null, separatorLevel: 3, icon: null },
      { title: "Our Mission", component: "GetOurMissionPage", separatorLevel: 4, icon: "gavel" },
      { title: "Our Stories", component: "GetOurStoriesPage", separatorLevel: 4, icon: "commenting" },
      { title: "Our Team", component: "GetOurTeamPage", separatorLevel: 4, icon: "address-card" }
    ];
  }
